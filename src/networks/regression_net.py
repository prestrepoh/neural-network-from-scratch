...
from src.networks.layer import affine_forward, affine_backward, sigmoid_forward, sigmoid_backward
from src.networks.base_networks import Network
...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        out, cache_affine1 = affine_forward(X, W1, b1)
        out, cache_sigmoid = sigmoid_forward(out)
        y, cache_affine2 = affine_forward(out,W2,b2)
